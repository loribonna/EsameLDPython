    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('common_start_pos', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='map.PosLatLng')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_time', models.CharField(default=datetime.datetime(2018, 7, 15, 15, 33, 55, 556367), max_length=5)),
